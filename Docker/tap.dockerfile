...
WORKDIR /Data
# Expecting Inputs, Inputs/DBs directory inside Data directory 

ENTRYPOINT ["cwl-runner" , "--no-container"  , "/CWL/Workflows/tap.prok.short.0.8.1.cwl"]
CMD [ "/CWL/Jobs/tap-default-job.yaml" ]
